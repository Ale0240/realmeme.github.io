...
if(mysqli_num_rows($result) > 0) {
    while($row = mysqli_fetch_assoc($result)) {
        // Output the data
        $msg = "Welcome back ". $row["First_Name"];
       
    }
} 
else {

    echo  " Welcometo Kin Jobs";
}
...
<div class="container-fluid">
  <section class="container-fluid" style="background:#002423;background:linear-gradient(180deg,rgba(0,0,35,.76) 10%,rgba(97,120,149,.0) 49%,#00d4ff 100%),url(browse.jpg);background-position:50%;background-repeat:no-repeat;background-size:cover;position:relative;width:100%">
  <div class="container">
...
<center>
<div class="card mt-1" style="background-color: #ced4da;border-color: #ced4da; ">
    <div class="card-body">
        <div class="row">
          <!--   <div class="col-2">
 ...
 <b><p style="color: green;font-size: 35px;background-color: white;">JOBS</p></b>
        </div>
     </div>
</div>
...
<!-- <form action="orderpage.php" method="post">
  ...
  <div class="container">
    <div class= "row">
      <div class="col-md-2 col-l-2 col-xl-3">
        <div class="card">
...
<div class="card mt-1">
    <div class="card-body">
        <div class="row">
            <div class="col-2">
                <img src="https://ui-avatars.com/api/?background=2596be&color=fff&name='.$name.'" style="border-radius:25%;">
            </div>
            <div class="col-8">
