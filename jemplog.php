...
if(isset($_POST['clogin'])) {
    ...
    $login = "SELECT * FROM `csignup` WHERE Email = '$cemail' AND Password = '$password'";
...
// if
?>
				<form method="POST" action="jemplog.php">
					...
					<button class="btn btn-primary" name="clogin" type="submit" style="width: 98%;">Log In</button>

					<br><br><span style="font-size: 13px;" class="text-muted">Don't have an account? <a href="jempsign.php"> Sign Up</a>
						<br>
					<a href="cforgets.php">forget password ?</a></span>  
	</form>
			</div>
		</div>
			</div>
